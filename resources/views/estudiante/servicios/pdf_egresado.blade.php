...
Prácticas Profesionales, en calidad de:
  ...
  <tr>
  <td width="90"><strong>EGRESADO</strong> </td>
  <div align="center">
...
<table id="generales2" style="font-size:14px" WIDTH="500" >
  <tr><td>
  Nombre del pasante(a): <?php if(empty($data->nombre)){ $vacio=null; echo $vacio;} else{ echo $data->nombre." ".$data->apellido_paterno;} ?> <?php if(empty($data->apellido_materno)){ $vacio=null; echo $vacio;} else{ echo $data->apellido_materno;} ?>
</td>
  </tr>
</table>
