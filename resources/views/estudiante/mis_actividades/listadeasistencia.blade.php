...
<table align="left" >
    <tr>
      <td colspan="4" style="font-size: 14px;"><strong>NOMBRE DE TALLER:</strong> </td>
      <td style="font-size: 11px;">{{$datos_extra->nombre_ec}}</td>
      <td colspan="4" style="font-size: 14px;"><strong>NOMBRE DE TUTOR:</strong></td>
    ...
    <br/><br/><br/><br/>
    <tr>
      <td colspan="4" style="font-size: 15px;"><strong>FECHA INICIO:</strong></td>
      <td style="font-size: 14px;">{{ date('d-m-Y', strtotime($datos_extra->fecha_inicio)) }}</td>
      <td colspan="4" style="font-size: 15px;"><strong>FECHA FIN:</strong></td>
      <td style="font-size: 14px;">{{ date('d-m-Y', strtotime($datos_extra->fecha_fin)) }}</td>
    </tr>

    <tr>
    <td colspan="4" style="font-size: 15px;"><strong>HORA DE ENTRADA:</strong> </td>
    <td style="font-size: 14px;">{{date("H:i a", strtotime($datos_extra->hora_inicio))}}</td>
    <td colspan="4" style="font-size: 15px;"><strong>HORA DE SALIDA:</strong></td>
...
/*  border-radius:40px 0 40px 0;-->*/
  ...
  <thead>
    <tr>
        ...
        <th style="width:200px; font-size: 11px;">NOMBRE</th>
        <th colspan="1" style="width:auto; font-size: 10px;" >TEL&Eacute;FONO</th>
        <th style="width:40px; font-size: 11px;">FIRMA</th>
        <th style="width:150px; font-size: 12px;">OBSERVACIONES</th>
        <th width="80" style="width:100px; font-size: 12px;" colspan="10">ASISTENCIAS</th>
    </tr>
  </thead>
  <tbody>
      ...
      <tr>
        ...
        <td style="width:250px; font-size: 11px;">{{$datos->nombre }} {{$datos->apellido_paterno }} {{$datos->apellido_materno }}</td>
