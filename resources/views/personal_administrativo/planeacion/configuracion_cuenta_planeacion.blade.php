...
<div class="table-responsive" style="border:2px solid #819FF7;">
  ...
  <thead>
    <tr>
      <td scope="col">  <h1 style="color: #0B173B; font-size: 20px;"><strong>Configuración contraseña</strong></h1>
                          ...
                          <form class="form-horizontal" method="POST" action="{{ route('changePassword_planeacion') }}" validate enctype="multipart/form-data" data-toggle="validator">
                              {{ csrf_field() }}
 ...
 <div class="col-md-12">
      ...
      <td scope="col">
	                            <form class="form-horizontal" method="POST" action="{{ route('changeUser_planeacion') }}" validate enctype="multipart/form-data" data-toggle="validator">
                              {{ csrf_field() }}
 ...
 <h1 style="color: #0B173B; font-size: 20px;"><strong>Datos de Usuario</strong></h1>
						   ...
						   <form class="form-horizontal" method="POST" action="{{ route('changeEmail_planeacion') }}" validate enctype="multipart/form-data" data-toggle="validator">
                              {{ csrf_field() }}
 ...
 <h1 style="color: #0B173B; font-size: 20px;"><strong></strong></h1>
	    ...
	    <td scope="col">
		  <form class="form-horizontal" method="POST" action="{{ route('changedatos_planeacion') }}" validate enctype="multipart/form-data" data-toggle="validator">
                              {{ csrf_field() }}
