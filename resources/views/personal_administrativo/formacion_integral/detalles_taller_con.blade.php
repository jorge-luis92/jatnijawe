...
@endsection
 ...
 <p align="left">&nbsp;&nbsp;
 <a href="/lista_inscritos_conferencias/{{$detalles->id_extracurricular}}/{{$detalles->id_tutor}}" target="_blank"><i class="fas fa-file-download"></i> Lista Inscritos </a>
</p>
                 
<div class="container" style="background-color:#87CEFA; " id="font7">
 </br>
       @include('flash-message')  
	    <h2 style="font-size: 1.3em; color: #000000;" align="center">Detalles de la Conferencia: {{$detalles->nombre_ec}}</h2>
...
<input type="date"  id="labels" class="form-control" disabled id="fecha_fin" value="{{ $detalles->fecha_inicio }}" >
</div>
<div class="form-group col-md-3">
