...
@endsection
 ...
 <p align="left">&nbsp;<a href="/lista_inscritos_taller/{{$detalles->id_extracurricular}}/{{$detalles->matricula}}" target="_blank"><i class="fas fa-file-download"></i> Lista Inscritos </a> &nbsp;&nbsp; 
                 <a href="/pdf_taller_aprobado/{{$detalles->matricula}}" target="_blank"><i class="fas fa-file-pdf"></i> PDF</a></p>
...
<label for="cupo"><strong>Fecha de Aprobación</strong></label>
