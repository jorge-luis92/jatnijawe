...
<div class="form-group">
  <div class="col-xs-offset-2 col-xs-9" align="center">
    <a  class="btn btn-primary" href="#" data-toggle="modal" data-target="#colaborar">Registrar</a>
    <!--  <button type="button"  class="btn btn-secondary" data-dismiss="modal">Cancelar</button>-->
  </div>
</div>

<div class="modal fade" id="colaborar" tabindex="-1" role="dialog" aria-labelledby="colaborando_ando" aria-hidden="true">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="colaborando_ando">Confirmar</h5>
<button class="close" type="button" data-dismiss="modal" aria-label="Close">
<span aria-hidden="true">×</span>
</button>
</div>
<div class="modal-body">Al dar clic en aceptar se agregarán los créditos de la actividad extracurricular al estudiante.</div>
