    ...
    @include('flash-message')
                      ...
                      <!--  <input type="text"  hidden size=10  maxlength=10 name="fecha_nac"   id="fecha_nac">-->
                        ...
                        <div class="form-group col-md-2">
                          ...
                          <input name="genero"  id="genero" onKeyUp="this.value = this.value.toUpperCase()" maxlength="1" type="text" class="form-control" >
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <label for="fecha_ingreso" >{{ __('* Fecha Ingreso') }}</label>
                                  <input id="fecha_ingreso" max= "<?php echo date("Y-m-d");?>" type="date"  class="form-control @error('fecha_ingreso') is-invalid @enderror" name="fecha_ingreso" required autocomplete="fecha_ingreso">
                                @error('fecha_ingreso')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
