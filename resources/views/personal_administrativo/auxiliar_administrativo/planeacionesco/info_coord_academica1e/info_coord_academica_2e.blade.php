...
<form  method="post" action="{{ route('info_coord_academica_2E') }}">
                         @csrf
<div class="form-row">
...
<a class="siguiente" href={{ route('info_coord_academica_1E')}}>1</a>
<a class="siguiente" href={{ route('info_coord_academica_2E')}}><strong>2</strong></a>
