...
<form  method="post" action="{{ route('reporte911_9A0') }}">
                         @csrf
<div class="form-row">
...
<a> Páginas</a>
<a class="siguiente" href={{ route('reporte911_9A0')}}><strong>1</strong></a>
<a class="siguiente" href={{ route('reporte911_9A1')}}>2</a>
<a class="siguiente" href={{ route('reporte911_9A2')}}>3</a>
<a class="siguiente" href={{ route('reporte911_9A3')}}>4</a>
