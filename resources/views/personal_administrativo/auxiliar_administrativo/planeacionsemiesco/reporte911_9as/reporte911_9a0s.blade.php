...
<form  method="post" action="{{ route('reporte911_9A0S') }}">
                         @csrf
<div class="form-row">
...
<a> Páginas</a>
<a class="siguiente" href={{ route('reporte911_9A0S')}}><strong>1</strong></a>
<a class="siguiente" href={{ route('reporte911_9A1S')}}>2</a>
<a class="siguiente" href={{ route('reporte911_9A2S')}}>3</a>
<a class="siguiente" href={{ route('reporte911_9A3S')}}>4</a>
