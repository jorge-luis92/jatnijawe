...
<form  method="post" action="{{ route('reporte911_9A1S') }}">
                         @csrf
<div class="form-row">
...
<a> Páginas</a>
    ...
    <a class="siguiente" align="rigth" href={{ route('reporte911_9A1S')}}><strong>2</strong></a>
    <a class="siguiente" align="rigth" href={{ route('reporte911_9A2S')}}>3</a>
    <a class="siguiente" align="rigth" href={{ route('reporte911_9A3S')}}>4</a>
