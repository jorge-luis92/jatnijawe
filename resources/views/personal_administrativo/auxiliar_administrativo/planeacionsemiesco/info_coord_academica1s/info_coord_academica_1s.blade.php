...
<form  method="post" action="{{ route('info_coord_academica_1S') }}">
                         @csrf
<div class="form-row">
  <div class="table-responsive">
    ...
    <tr>
      <td bgcolor="white">{{$totalactualM_S}}</td>
      <td bgcolor="white">{{$totalactualF_S}}</td>
      <td bgcolor="white">{{$totalactualT_S}}</td>
      <td bgcolor="white">{{$discapacidadesTCU_S}}</td>
      <td bgcolor="white">{{$conteo_lengua_S}}</td>
    </tr>
    </table>
  ...
  <a> Páginas</a>
  <a class="siguiente" href={{ route('info_coord_academica_1S')}}><strong>1</strong></a>
  <a class="siguiente" href={{ route('info_coord_academica_2S')}}>2</a>
