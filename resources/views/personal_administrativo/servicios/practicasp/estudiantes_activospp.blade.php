...
<div class="container" id="font7">
     ...
     <form action="{{route ('busqueda_activos_pr')}}" method="POST" role="search">
        {{ csrf_field() }}
         <div class="form-row">
    ...
    <tbody>
      ...
      <td> <a href="ingresar_folio/{{$detalles->matricula}}/{{$detalles->id_practicas}}" >Carta de presentación</a></td>
      <td> <a href="ingresar_fechas/{{$detalles->id_practicas}}/{{$detalles->matricula}}/{{$detalles->periodo_practicas}}" >Ingresar Fechas</a></td>
      <td> <a href="practicas_acreditar/{{$detalles->id_practicas}}/{{$detalles->matricula}}" target= "_blank">Carta de Liberación</a></td>
      <td> <a href="practicas_cancelar/{{$detalles->id_practicas}}">Cancelar</a></td>
          </tr>
          @endforeach
      </tbody>
  </table>
