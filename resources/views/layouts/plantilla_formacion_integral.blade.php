      ...
      <li class="nav-item" >
        ...
        <div id="datos_estudiante" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
			...
			<a class="collapse-item" href={{ route('talleres_rechazados_estudiante')}}>Talleres Rechazados</a>
            <a class="collapse-item" href={{ route('notificaciones_enviadas')}}>Notificaciones Enviadas</a>
            <a class="collapse-item" href={{ route('fecha_solicitud')}}>Activar/Cerrar Periodo </br>de Solicitudes de Taller</a>
...
<!-- Sidebar Toggler (Sidebar) -->
 ...
 <li class="nav-item" >
       <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#registro_encuestas" aria-expanded="true" aria-controls="collapseTwo">
               <i class="fa fa-question-circle" aria-hidden="true"></i><span style="font-size: 0.8em;">&nbsp;Encuestas</span>
      </a>
	   <div id="registro_encuestas" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header" style="color: blue">Opciones:</h6>
          <!--  <a class="collapse-item" href={{ route('registro_extracurricular')}}>Agregar Actividad</a>-->
            <a class="collapse-item" href={{ route('fecha_encuesta')}}>Activar/Cerrar periodo </br>de encuestas</a>
              <a class="collapse-item"  href={{ route('resultados_encuesta')}}>Resultados encuestas</a>
                      </div>
        </div>
    </li>
    <!-- Nav Item - Pages Collapse Menus -->
    <li class="nav-item">
      <a class="nav-link"  target="_blank"  href="{{asset('manuales_administrativos/MUFI.pdf')}}" aria-expanded="true">
          ...
          -->
              ...
              <li class="nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    <a class="dropdown-item" href={{ route('cuenta_formacion')}}>
