...
<!-- Sidebar Toggler (Sidebar) -->
    ...
    <li class="nav-item">
      <a class="nav-link"  target="_blank"  href="{{asset('manuales_administrativos/MUTALLERISTA.pdf')}}" aria-expanded="true">
          ...
          -->
              ...
              <li class="nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    <a class="dropdown-item" href={{ route('cuenta_tallerista')}} >
