...
<body id="page-top">
  ...
  <i class="fa fa-file" aria-hidden="true"></i></i><span style="font-size: 0.8em;">&nbsp;Reportes</span>
        ...
        <!--      <a class="collapse-item" href={{ route('reporte_semestral')}}>Semestral</a>-->
              ...
              <a class="collapse-item" href={{ route('info_practicasp')}}>Prácticas Profesionales </br>y Servicio Social</a>
      ...
      <li class="nav-item">
      <a class="nav-link"   target="_blank"  href="{{asset('manuales_administrativos/MUP.pdf')}}" aria-expanded="true">
            ...
            <!-- Nav Item - User Information -->
              ...
              <li class="nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    <a class="dropdown-item" href={{ route('cuenta_planeacion')}} >
