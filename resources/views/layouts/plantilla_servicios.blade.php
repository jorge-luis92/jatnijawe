    ...
    <ul class="navbar-nav sidebar sidebar-dark" style="background-color: #0A122A; font-size: 1.0em;" id="accordionSidebar" ><!-- Sidebar - Brand -->
      ...
      <li class="nav-item" >
        ...
        <div id="busqueda_coordinador" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
         ...
         <a class="collapse-item" href={{ route('expedientes_practicas_profesionales')}}>Expedientes</a>
          <!--  <a class="collapse-item" href={{ route('cancelados_practicas')}}>Cancelados</a>-->
          </div>
        </div>
      </li>
      ...
      <li class="nav-item" >
        ...
        <div id="usuario" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href={{ route('estudiantes_activos_ss')}}>Estudiantes Activos</a>
           <a class="collapse-item" href={{ route('expedientes_servicio_social')}}>Expedientes</a>
      ...
      <li class="nav-item" >
	    ...
	    <li class="nav-item" >
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#planeacion" aria-expanded="true" aria-controls="collapseTwo">
        <i class="fa fa-file" aria-hidden="true"></i></i><span style="font-size: 0.8em;">&nbsp; Planeación </span>
        </a>
        <div id="planeacion" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header" style="color: blue">Opciones:</h6>
          <a class="collapse-item" href={{ route('info_practicas')}}> Reporte </a>
      ...
      <li class="nav-item">
      <a class="nav-link"   target="_blank"  href="{{asset('manuales_administrativos/MUPS.pdf')}}" aria-expanded="true">
            ...
            <!-- Nav Item - User Information -->
              ...
              <li class="nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    <a class="dropdown-item" href={{ route('cuenta_ppssocial')}} >
